...
{ 
    public class Dado
    {
        ...
        public uint QtFace;
        public virtual int Rolar() => Rnd.Next((int)QtFace + 1);
    ...
    public class Rolagem
    {
        ...
        public override string ToString() => $"{QtRolagens}D{Dado.QtFace}+{Modificador}";
